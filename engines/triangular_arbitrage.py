...
class CryptoEngineTriArbitrage(object):
   ...
   #Check different opportunities which can give us arbitrage opportunities 
            ...
            for pairs in self.all_combinations:                
              ...
              #1st Step check if the profit will be more than the fees + trades
                if bidRoute_result > 1 and percentage_profit_bidRoute > 0.86 :
                    self.place_the_order_of_the_bidRoute(pairs, lastPrices,askRates,bidRates, bidRoute_result,percentage_profit_bidRoute )
    ...
    def place_the_order_of_the_bidRoute(self , pairs, lastPrices,askRates,bidRates,  bidRoute_result,percentage_profit_bidRoute ):
